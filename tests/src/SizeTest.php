...
final class SizeTest extends PHPUnit_Framework_TestCase
{
    ...
    public function maxDataProvider()
    {
        return [
            ...
            [null, 10, true],
            [new CountThree(), 3, true],
            [new CountThree(), 2, false],
            [new CountThree(), 100, true],
    ...
    public function minDataProvider()
    {
        return [
            ...
            [null, -10, true],
            [new CountThree(), 3, true],
            [new CountThree(), 20, false],
            [new CountThree(), -100, true],
            [new CountThree(), -1, true],
            [new \stdClass(), 1, true],
            [new \stdClass(), 0, true],
    ...
    public function betweenDataProvider()
    {
        return [
            ...
            ['foo', [0, 3], true],
            ['foo', [3, 20], true],
            [new CountThree(), [4, 20], false],
            [new CountThree(), [-1, 2], false],
            [new CountThree(), [-1, 20], true],
            [new CountThree(), [0, 3], true],
            [new CountThree(), [3, 20], true],
            [['a', 'b', 'c'], [4, 20], false],
            [['a', 'b', 'c'], [-1, 2], false],
            [['a', 'b', 'c'], [-1, 20], true],
            [['a', 'b', 'c'], [0, 3], true],
    ...
    public function betweenInnerDataProvider()
    {
        return [
            ...
            [new CountThree(), [-1, 2], false],
            [new CountThree(), [-1, 20], true],
            [new CountThree(), [0, 3], false],
            [new CountThree(), [3, 20], false],
            [['a', 'b', 'c'], [4, 20], false],
            [['a', 'b', 'c'], [-1, 2], false],
            [['a', 'b', 'c'], [-1, 20], true],
            [['a', 'b', 'c'], [0, 3], false],
